#
#  Be sure to run `pod spec lint BMSLocationKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/sujiewen/BMSLocationKit.git", :tag => "#{s.version}" }
